...
export const DATA_CAPTURE_I18N = {
  en: {
    ...
    removeWordHelp: "For multiple words, use commas (,). To match only one exact word, put = before it.",
    ...
    deleteDraftTitle: "Clear the entire data capture table",
  ...
  zh: {
    ...
    deleteDraftTitle: "清空整张 Data Capture 表格",
