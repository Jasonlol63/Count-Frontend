...
export const BANK_PROCESS_I18N = {
  en: {
    ...
    deleteBankBalance: "Delete Bank Balance",
    deleteBankBalanceTitle: "Delete Bank Balance",
    deleteBankBalanceMessage: "Delete the Contra transaction for this Bank Balance amount? This cannot be undone.",
    deleteBankBalanceFailed: "Failed to delete Bank Balance",
    bankBalanceDeleted: "Bank Balance deleted",
    ...
    noDueForDate: "No process due for accounting on {date}.",
    refresh: "Refresh",
    close: "Close",
    ...
    accountingDueAsOfLabel: "Early Transaction Date",
    accountingDueAsOfReset: "Back to today",
    accountingDueAsOfSuffix: "· as of {date}",
    accountingDueAsOfBanner: "Showing bills due as of {date}, including early items you can transact now.",
    accountingDueEarlyBadge: "Early",
    accountingDueChip1Week: "+1 Week",
    accountingDueChip2Week: "+2 Weeks",
    accountingDueChip1Month: "+1 Month",
    accountingDueChipYearEnd: "Year End",
  ...
  zh: {
    ...
    bankBalance: "银行余额",
    deleteBankBalance: "删除银行余额",
    deleteBankBalanceTitle: "删除银行余额",
    deleteBankBalanceMessage: "确定要删除这笔银行余额对应的 Contra 交易吗？此操作不可撤销。",
    deleteBankBalanceFailed: "删除银行余额失败",
    bankBalanceDeleted: "银行余额已删除",
    ...
    noDueForDate: "{date} 没有待入账流程。",
    refresh: "刷新",
    close: "关闭",
    accountingDueAwaiting: "{count} 条流程待入账",
    accountingDueAwaitingPlural: "{count} 条流程待入账",
    transaction: "入账",
    accountingDueAsOfLabel: "提前交易日期",
    accountingDueAsOfReset: "回到今天",
    accountingDueAsOfSuffix: "· 截至 {date}",
    accountingDueAsOfBanner: "正在显示截至 {date} 视角下的到期账单，其中包含可提前入账的项目。",
    accountingDueEarlyBadge: "提前",
    accountingDueChip1Week: "+1周",
    accountingDueChip2Week: "+2周",
    accountingDueChip1Month: "+1月",
    accountingDueChipYearEnd: "年底",
