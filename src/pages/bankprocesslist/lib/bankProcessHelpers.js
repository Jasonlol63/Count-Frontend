...
export function normalizeBankProcessListItem(dto) {
  ...
  return {
    ...
    customer: String(dto.customerAccountCode || dto.customerAccountName || "").trim(),
    card_merchant_name: String(dto.supplierAccountCode || dto.supplierAccountName || "").trim(),
...
export function normalizeAccountingDueRow(dto) {
  ...
  return {
    ...
    status: normalizeBankProcessStatus(statusSource),
    issue_flag: normalizeBankIssueFlag(statusSource),
    card_merchant_name: dto.supplierAccountCode || dto.supplierAccountName || "",
    cost: moneyFieldToString(dto.supplierPrice),
    customer: dto.customerAccountCode || dto.customerAccountName || "",
