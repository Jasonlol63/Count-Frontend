...
import { formatDmyDash, formatYmd, parseDdMmYyyyToYmd, parseYmd } from "./dateUtils.js";
...
/**
 * Profit has no % input in the UI (see DomainSettingsSheet) — its share is always the remainder
